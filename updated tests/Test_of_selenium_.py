...
class Test_sauce:
    ...
    def test_none_user(self, kullaniciadi, sifre):
        ...
        self.driver.save_screenshot(f"{self.folderpath}\{inspect.currentframe().f_code.co_name}{kullaniciadi,sifre}.png")
    ...
    def test_twitter_btn_ctrl(self):
        ...
        for sekme in self.driver.window_handles:
            if sekme != self.driver.current_window_handle:
                self.driver.switch_to.window(sekme)
        Current_url = self.driver.current_url
        self.driver.save_screenshot(f"{self.folderpath}\{inspect.currentframe().f_code.co_name}.png")
        assert Current_url.startswith(C.expected_twitter_url)
    ...
    def test_fb_btn_ctrl(self):
        ...
        Current_url = self.driver.current_url
        self.driver.save_screenshot(f"{self.folderpath}\{inspect.currentframe().f_code.co_name}.png")
        assert Current_url.startswith(C.expected_fb_url)
    ...
    def test_linkedin_btn_ctrl(self):
        ...
        self.driver.save_screenshot(f"{self.folderpath}\{inspect.currentframe().f_code.co_name}.png")
        assert Current_url.startswith(C.expected_linkedin_url)  
        
    @pytest.mark.xfail() #Son ürünün adı hatalı olduğu için assertion error dönüyor.
